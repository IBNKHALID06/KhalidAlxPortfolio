...
import aquanourReports from "../assets/aquanour_reports.jpg";
import aquanourAnalytics from "../assets/aquanour_analytics.jpg";
import aquanourAbout from "../assets/aquanour_about.jpg";
      ...
      <div className="space-y-16">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              <ImageBox src={aquanourAbout} />
              <p className="text-center text-slate-400 text-sm">About Us</p>
            </div>
          </div>
        </section>
      </div>
